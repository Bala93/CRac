...
CLASSES = ('background','Liver','Kidney','Spleen','Pancreas')
...
def get_train_val_loader(data_root, batch_size=32, num_workers=8, ratio=1, pin_memory=True):
    ...
    valid_dataset = AbdomenDataset(valid_files, 'valid')
    ...
    valid_loader = DataLoader(valid_dataset, batch_size=1, shuffle=False, num_workers=num_workers, pin_memory=pin_memory)
...
def get_post_temp_scaling_loader(data_root, batch_size=32, num_workers=8, pin_memory=True):
    ...
    test_dataset = AbdomenDataset(test_files)
